...
export const AuthDemoNavigator = () => {
  return (
    <Stack.Navigator screenOptions={{headerShown: false}}>
      <Stack.Screen
        name={RouteName.SIGN_IN_DEMO}
        component={SignInDemoScreen}
      />
      <Stack.Screen
        name={RouteName.SIGN_UP_DEMO}
        component={SignUpDemoScreen}
      />
      <Stack.Screen
        name={RouteName.FORGOT_PASSWORD_DEMO}
        component={ForgotPasswordDemoScreen}
      />
    </Stack.Navigator>
  );
};
