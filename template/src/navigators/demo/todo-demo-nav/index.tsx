...
export const TodoDemoNavigator = () => {
  return (
    <Stack.Navigator screenOptions={{headerShown: false}}>
      <Stack.Screen
        name={RouteName.TODO_LIST_DEMO}
        component={TodoListDemoScreen}
      />
      <Stack.Screen
        name={RouteName.TODO_LIST_TYPICODE_DEMO}
        component={TodoListTypicodeDemoScreen}
      />
      <Stack.Screen
        name={RouteName.TODO_DETAIL_DEMO}
        component={TodoDetailDemoScreen}
      />
    </Stack.Navigator>
  );
};
