...
function navigateToWeb(params: WebParams) {
  ...
  if (url.startsWith('http')) {
    return __DEV__
      ? navHelper.navigate(RouteName.WEB, {url: url})
      : Linking.openURL(url);
  }
...
function navigateToSignInDemo(params?: SignInDemoParams) {
  navHelper.navigate(RouteName.AUTH_DEMO_NAV, {
    screen: RouteName.SIGN_IN_DEMO,
    params: params,
  });
}
...
function navigateToForgotPasswordDemo(params?: ForgotPasswordDemoParams) {
  navHelper.navigate(RouteName.AUTH_DEMO_NAV, {
    screen: RouteName.FORGOT_PASSWORD_DEMO,
    params: params,
  });
}

function navigateToTodoListDemo(params: TodoListDemoParams) {
  navHelper.navigate(RouteName.TODO_NAV_DEMO, {
    screen: RouteName.TODO_LIST_DEMO,
    params: params,
  });
}
...
function navigateToTodoListTypicodeDemo() {
  navHelper.navigate(RouteName.TODO_NAV_DEMO, {
    screen: RouteName.TODO_LIST_TYPICODE_DEMO,
  });
}
